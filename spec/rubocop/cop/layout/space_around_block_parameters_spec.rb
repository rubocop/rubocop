...
RSpec.describe RuboCop::Cop::Layout::SpaceAroundBlockParameters, :config do
  ...
  context 'when EnforcedStyleInsidePipes is no_space' do
    ...
    let(:other_cops) { { 'Layout/SpaceInsideParens' => { 'Enabled' => false } } }
  ...
  context 'when `Layout/SpaceInsideParens` is enabled' do
    context 'when EnforcedStyleInsidePipes is space' do
      let(:cop_config) { { 'EnforcedStyleInsidePipes' => 'space' } }

      context 'and `Layout/SpaceInsideParens` enforces the same style' do
        let(:other_cops) do
      ...
      context 'and `Layout/SpaceInsideParens` enforces `compact`' do
        let(:other_cops) do
          { 'Layout/SpaceInsideParens' => { 'Enabled' => true, 'EnforcedStyle' => 'compact' } }
        end
      ...
      context 'and `Layout/SpaceInsideParens` enforces a conflicting style' do
        let(:other_cops) do
