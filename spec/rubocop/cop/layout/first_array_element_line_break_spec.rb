...
RSpec.describe RuboCop::Cop::Layout::FirstArrayElementLineBreak, :config do
  ...
  context 'when `AllowImplicitArrayBrackets` is false' do
    let(:cop_config) { { 'AllowImplicitArrayBrackets' => false } }
  ...
  context 'when `AllowImplicitArrayBrackets` is true' do
    let(:cop_config) { { 'AllowImplicitArrayBrackets' => true } }
