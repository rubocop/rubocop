...
RSpec.describe RuboCop::Cop::Style::HashDig, :config do
  context 'with chained `fetch` methods' do
    shared_examples_for 'replaceable' do |argument|
    ...
    it_behaves_like 'replaceable', 'nil'
    it_behaves_like 'replaceable', '{}'
    it_behaves_like 'replaceable', 'Hash.new'
    it_behaves_like 'replaceable', '::Hash.new'
  end
