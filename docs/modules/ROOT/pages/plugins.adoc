...
To skip cops that need a newer version of the gem than the one the setting names,
see xref:development.adoc#honoring-a-target-version-setting[Honoring a target version setting].
