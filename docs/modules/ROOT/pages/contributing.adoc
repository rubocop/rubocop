...
Before submitting a pull request make sure all tests are
...
. Pick an issue from the https://github.com/rubocop/rubocop/issues[issue tracker] (look for `good first issue` or `help wanted` labels).
. Create a feature branch: `git checkout -b fix-1234-short-description`.
. Make your changes and add tests (see xref:development.adoc[Development]).
