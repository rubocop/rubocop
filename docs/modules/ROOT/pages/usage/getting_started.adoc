...
This guide will get you up and running with RuboCop in a few minutes.
...
* xref:usage/basic_usage.adoc[Basic Usage] — full CLI reference with all command-line flags
