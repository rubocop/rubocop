...
==== IgnoredMethods: [] (default) with EnforcedStyle: predicate
...
==== IgnoredMethods: [==] with EnforcedStyle: predicate
...
==== IgnoredMethods: [respond_to, define_method] (default)
