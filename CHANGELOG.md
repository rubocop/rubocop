...
* [#2433](https://github.com/bbatsov/rubocop/pull/2433): Add a configuration to `Style/ConditionalAssignment` to check and correct conditionals that contain multiple assignments. ([@rrosenblum][])
