...
* [#12794](https://github.com/rubocop/rubocop/issues/12794): Fix false positives for `Style/RedundantArgument` when single-quoted strings for cntrl character. ([@koic][])
