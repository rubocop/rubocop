...
* [#8533](https://github.com/rubocop-hq/rubocop/pull/8533): Fix a false positive for `Lint/BinaryOperatorWithIdenticalOperands` when using `*` operator with same variable operand. ([@koic][])
