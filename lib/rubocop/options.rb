...
module RuboCop
  ...
  class Options
    ...
    def add_config_generation_options(opts)
      section(opts, 'Config Generation') do
        ...
        option(opts, '--[no-]auto-gen-version')
  ...
  class OptionsValidator
    ...
    def validate_auto_gen_config
      ...
      %i[exclude_limit offense_counts auto_gen_timestamp auto_gen_version
  ...
  module OptionsHelp
    ...
    TEXT = {
      ...
      offense_counts:                   ['Include offense counts in configuration',
                                         ...
                                         'Default is true.'],
      auto_gen_timestamp:
                                        ['Include the date and time when --auto-gen-config',
                                         'was run in the file it generates. Default is true.'],
      auto_gen_version:
                                        ['Include the current RuboCop version when generating',
