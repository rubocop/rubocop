  ...
  module Formatter
    ...
    class DisabledConfigFormatter < BaseFormatter # rubocop:disable Metrics/ClassLength
      ...
      def finished(_inspected_files)
        output.puts format(HEADING, command: command, stamp: stamp)
      ...
      def show_version?
        @options.fetch(:auto_gen_version, true)
      end
      ...
      def command
        ...
        command += ' --no-auto-gen-version' unless show_version?
      ...
      def stamp
        return '' unless show_timestamp? || show_version?

        "#{[timestamp, version].reject(&:blank?).join(' ')}."
      end
      ...
      def version
        show_version? ? "using RuboCop version #{Version::STRING}" : ''
      end
