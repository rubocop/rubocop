  ...
  module Cop
    ...
    module PrecedingFollowingAlignment
      ...
      def aligned_with_something?(range)
        ...
        return true if aligned_with_line?(pre, range) ||
                       aligned_with_line?(post, range)
        ...
        aligned_with_line?(pre, range, base_indentation) ||
          aligned_with_line?(post, range, base_indentation)
      end
      ...
      def aligned_with_line?(line_nos, range, indent = nil)
        ...
        line_nos.each do |lineno|
          ...
          return (aligned_words?(range, line) ||
