...
module RuboCop
  module Cop
    module Lint
      ...
      #
      # With `IgnoreDuplicateElseBranches: true`, in conditionals with multiple branches,
      ...
      #   end
      #
      # @example IgnoreDuplicateElseBranches: true
      #   # good
      #   if foo
      #     do_foo
      #   elsif bar
      ...
      class DuplicateBranch < Base
        ...
        def ignore_duplicate_else_branches?
          cop_config.fetch('IgnoreDuplicateElseBranches', false)
        end
